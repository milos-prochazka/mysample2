...
class ValueState<T> extends ChangeNotifier implements ValueListenable<T>
{
  ...
  P read<P>() => presenter == null ? _value as P : presenter!<T, P>(_value as T);
  ...
  getWidgetBuilder(BuildContext context,
    {required ValueWidgetBuilder<T> widgetBuilder, EventBinder_ValueBuilder? valueBuilder, Widget? child})
  {
    return ValueListenableBuilder(builder: widgetBuilder, valueListenable: this, child: child);
  }
}