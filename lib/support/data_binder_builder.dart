...
class DataBinderBuilder
{
  ...
  )
  {
    ...
    return binder.getValue(bindValue, defValue: '').buildWidget
    (
      context, //
  ...
  )
  {
    ...
    (
      ...
      child: child, builder: (context, value, child)
      {
        ...
        (
          key: key,
          onPressed: enableEvent ? (() => value.doEvent(event: StdValueProperty.onPressed)) : null,
          onLongPress: enableEvent ? (() => value.doEvent(event: StdValueProperty.onLongPress)) : null,
          onHover: enableEvent ? ((param) => value.doEvent(event: StdValueProperty.onHover)) : null,
          onFocusChange: enableEvent ? ((param) => value.doEvent(event: StdValueProperty.onFocusChanged)) : null,
          style: binder.readOrDefault
          (
            defaultValue: style, sourceValueName: styleValue, propertySource: value, keyParameter: styleParam
          ),
  ...
  )
  {
    ...
    (
      ...
      child: label, builder: (context, value, label)
      {
        ...
        (
          key: key,
          onPressed: enableEvent ? (() => value.doEvent(event: StdValueProperty.onPressed, parameter: null)) : null,
          onLongPress: enableEvent ? (() => value.doEvent(event: StdValueProperty.onLongPress, parameter: null)) : null,
          onHover: enableEvent ? ((param) => value.doEvent(event: StdValueProperty.onHover, parameter: null)) : null,
          onFocusChange:
          enableEvent ? ((param) => value.doEvent(event: StdValueProperty.onFocusChanged, parameter: null)) : null,
          style: binder.readOrDefault
          (
            defaultValue: style, sourceValueName: styleValue, propertySource: value, keyParameter: styleParam
          ),
    ...
    (
      ...
      builder: (context, value, label)
      {
        ...
        (
          ...
          onPressed: enableEvent ? (() => value.doEvent(event: StdValueProperty.onPressed)) : null,
          onLongPress: enableEvent ? (() => value.doEvent(event: StdValueProperty.onLongPress)) : null,
          onHover: enableEvent ? ((param) => value.doEvent(event: StdValueProperty.onHover, parameter: param)) : null,
          onFocusChange:
          enableEvent ? ((param) => value.doEvent(event: StdValueProperty.onFocusChanged, parameter: param)) : null,
          style: binder.readOrDefault
          (
            defaultValue: style, sourceValueName: styleValue, propertySource: value, keyParameter: styleParam
          ),
    ...
    (
      ...
      builder: (context, value, label)
      {
        ...
        (
          ...
          onTap: () => enableEvent ? value.doEvent(event: StdValueProperty.onClicked) : null,
          elevation: elevation,
          underline: underline,
          icon: icon,
        ...
        (
          ...
          (
            ...
            (
              ...
              : (newValue) => (value.doEvent(event: null, parameter: newValue))
            )
            : null
          ),
          // mouseCursor
      ...
      builder: <T>(context, v, child)
      {
        ...
        (
          ...
          (
            setValueAfterOnChanged
            ? (newValue) => value.value = newValue
            : (newValue) => value.doEvent(event: StdValueProperty.onChanged, parameter: newValue)
          )
          : null,
          // mouseCursor
          mouseCursor: binder.readOrDefault
  ...
  )
  {
    ...
    return binder.getValue<double>(bindValue, defValue: min).buildWidget
    (
      context, //
      builder: (context, value, child)
      {
        ...
        (
          ...
          (
            enableEvent
            ? (newValue) => value.doEvent(event: StdValueProperty.onChangeStart, parameter: (newValue))
            : null
          ),
          onChangeEnd:
          (
            enableEvent
            ? (newValue) => value.doEvent(event: StdValueProperty.onChangeEnd, parameter: (newValue))
            : null
          ),
          min: min,
          max: max,
  ...
  )
  {
    ...
    (
      ...
      builder: (context, value, child)
      {
        ...
        (
          key: key,
          onSelected: (newValue) => value.doEvent(event: StdValueProperty.onSelect, parameter: newValue),
          onCanceled: () => value.doEvent(event: StdValueProperty.onCanceled),
          enabled: binder.readOrDefault
          (
            defaultValue: enabled,
            sourceValueName: enabledValue,
